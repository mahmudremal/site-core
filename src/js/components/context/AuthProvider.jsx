...
export const AuthProvider = ({ children }) => {
                        ...
                        return (
                            <div className="max-w-md mx-auto text-center">
                                <header className={`${error ? 'mb-4' : 'mb-8'}`}>
                                    <h6 className="text-xl font-bold mb-1">{__('Email Verification')}</h6>
                                    <p className="text-[15px] text-slate-500">{__('Enter the 4-digit verification code that was sent to your email.')}</p>
                                    {error ? (
                                        <div className="alert alert-danger bg-danger-100 text-danger-600 border-danger-100 px-24 py-11 mb-0 fw-semibold text-lg radius-8 flex items-center justify-between mt-4" role="alert">
    ...
    return (
        <AuthContext.Provider value={{ auth, setAuth, logout }}>
            {auth ? (
                <section className="auth bg-base flex flex-wrap h-screen overflow-hidden overflow-y-auto">
                    <div className="auth-left d-none d-lg-block">
                        <div className="flex items-center flex-column h-100 justify-content-center relative">
                            <img src={isReset ? resetImage : authImage} alt={__('Authentication screen banner')} />
                            <div className="absolute top-0 left-0 w-full h-full"></div>
                        </div>
                    </div>
                    <div className="auth-right py-32 px-24 flex flex-column justify-content-center">
                        <div className={`${form?.isSignUp ? 'max-w-464-px' : 'max-w-xl'} mx-auto w-100`}>
                            <div>
                                ...
                                {error && (
                                    <div className="mb-16">
                                        <div className="alert alert-danger bg-transparent text-danger-600 border-danger-600 px-24 py-11 mb-0 fw-semibold text-lg radius-8 flex items-center justify-between" role="alert">
                                            <span dangerouslySetInnerHTML={{ __html: error }}></span>
                                        </div>
                                    </div>
                                )}
                                        ...
                                        <button
                                            ...
                                            onClick={(e) => {
                                                ...
                                                request(rest_url('/sitecore/v1/reset-password'), {
                                                    ...
                                                    .catch((err) => setPopup(
                                                        <div className="text-center flex flex-col items-center gap-5 text-primary-400">
                                            ...
                                            <div className="">
                                                <div className="flex justify-between gap-2">
                                                    <div className="form-check style-check flex align-items-start">
                                                        ...
                                                        <label className="form-check-label text-sm" htmlFor="condition" dangerouslySetInnerHTML={{
                                                            __html: sprintf(
