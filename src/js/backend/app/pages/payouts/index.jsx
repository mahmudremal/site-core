        ...
        <div className="card xpo_p-0 radius-12">
            <div className="card-header border-bottom bg-base py-16 px-24 xpo_flex xpo_items-center xpo_flex-wrap xpo_gap-3 xpo_justify-content-between">
                ...
                <button
                    ...
                    className="btn btn-primary xpo_text-sm btn-sm px-12 py-12 radius-8 xpo_flex xpo_items-center xpo_gap-2"
                >
                        ...
                        <table className="table bordered-table sm-table xpo_mb-0">
                            ...
                            <tbody>
                                {transactions?.length > 0 ? transactions.map((item, index) => (
                                    ...
                                    //             <Link to={ home_url(`/transactions/${item.id}/view`) } className="bg-info-focus xpo_text-info-600 xpo_w-40-px xpo_h-40-px rounded-circle xpo_flex xpo_justify-center xpo_items-center" ><Eye className="icon xpo_text-xl" /></Link>
                                    //             <button
            ...
            <div className="xpo_space-y-3">
                ...
                <div className="xpo_space-y-1">
                    ...
                    <p className="xpo_text-sm xpo_flex xpo_gap-1 xpo_items-center">
                        ...
                        {status === "approved" ? (
                            <span className="text-success-main xpo_mb-0 xpo_capitalize"> {status}</span>
                        ) : (
