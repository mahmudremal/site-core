    ...
    return (
        <div className="xpo_flex xpo_flex-col xpo_gap-4">
            <div className="xpo_grid xpo_gap-4 xpo_grid-cols-2 md:xpo_grid-cols-4">
                <div>
                    <div className="card-body xpo_p-5 bg-base border xpo_h-100 xpo_flex xpo_flex-column xpo_justify-content-center border-end-0">
                        <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-content-between xpo_gap-1 xpo_mb-8">
                            <div>
                                <span className="mb-12 xpo_w-44-px xpo_h-44-px xpo_text-primary-600 bg-primary-light border border-primary-light-white xpo_flex-shrink-0 xpo_flex xpo_justify-content-center xpo_items-center radius-8 h6 xpo_mb-12">
                ...
                <div>
                    <div className="card-body xpo_p-5 bg-base border xpo_h-100 xpo_flex xpo_flex-column xpo_justify-content-center border-end-0">
                        <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-content-between xpo_gap-1 xpo_mb-8">
                            <div>
                                <span className="mb-12 xpo_w-44-px xpo_h-44-px xpo_text-yellow bg-yellow-light border border-yellow-light-white xpo_flex-shrink-0 xpo_flex xpo_justify-content-center xpo_items-center radius-8 h6 xpo_mb-12">
                ...
                <div>
                    <div className="card-body xpo_p-5 bg-base border xpo_h-100 xpo_flex xpo_flex-column xpo_justify-content-center border-end-0">
                        <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-content-between xpo_gap-1 xpo_mb-8">
                            <div>
                                <span className="mb-12 xpo_w-44-px xpo_h-44-px xpo_text-lilac bg-lilac-light border border-lilac-light-white xpo_flex-shrink-0 xpo_flex xpo_justify-content-center xpo_items-center radius-8 h6 xpo_mb-12">
                ...
                <div>
                    <div className="card-body xpo_p-5 bg-base border xpo_h-100 xpo_flex xpo_flex-column xpo_justify-content-center">
                        <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-content-between xpo_gap-1 xpo_mb-8">
                            <div>
                                <span className="mb-12 xpo_w-44-px xpo_h-44-px xpo_text-pink bg-pink-light border border-pink-light-white xpo_flex-shrink-0 xpo_flex xpo_justify-content-center xpo_items-center radius-8 h6 xpo_mb-12">
