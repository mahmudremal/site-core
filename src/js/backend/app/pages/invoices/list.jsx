...
export default function InvoicesList({  }) {
    ...
    const fetchInvoices = async () => {
        setLoading(true);
        try {
            const res = await request(rest_url(`/sitecore/v1/invoice/list?page=${page}&s=${search}&status=${status}&per_page=${perPage}`));
    ...
    return (
        <div className="card xpo_p-0 radius-12">
            <div className="card-header border-bottom bg-base py-16 px-24 xpo_flex xpo_items-center xpo_flex-wrap xpo_gap-3 xpo_justify-content-between">
                ...
                <Link to={ home_url('/invoices/0/view') } className="btn btn-primary xpo_text-sm btn-sm px-12 py-12 radius-8 xpo_flex xpo_items-center xpo_gap-2">
                                ...
                                {invoices.length > 0 ? invoices.map((invoice, index) => (
                                    <tr key={invoice.id}>
                                        ...
                                        <td className="text-center">
                                            <span
                                                className={ `border ${invoice.status === 'paid' ? 'bg-success-focus xpo_text-success-600 border-success-main xpo_text-success-main' : 'bg-warning-focus xpo_text-warning-600 border-warning-main xpo_text-warning-main'} px-24 py-4 radius-4 fw-medium xpo_text-sm xpo_capitalize` }
                                        ...
                                        <td className="text-center">
                                            <div className="xpo_flex xpo_items-center xpo_gap-10 xpo_justify-content-center">
                                                <a
                                                    ...
                                                    className="bg-info-focus xpo_text-info-600 xpo_w-40-px xpo_h-40-px rounded-circle xpo_flex xpo_justify-center xpo_items-center" target="_blank"
                                                    onClick={(e) => {
