    ...
    return (
        <div className="card xpo_p-0 radius-12">
            <div className="card-header border-bottom bg-base py-16 px-24 xpo_flex xpo_items-center xpo_flex-wrap xpo_gap-3 xpo_justify-content-between">
                ...
                <Link to={ home_url('/users/0/edit') } className="btn btn-primary xpo_text-sm btn-sm px-12 py-12 radius-8 xpo_flex xpo_items-center xpo_gap-2">
                                        ...
                                        <tr key={user.id}>
                                            ...
                                            <td className="text-center">
                                                <div className="xpo_flex xpo_items-center xpo_gap-10 xpo_justify-content-center">
                                                    <Link to={ home_url(`/users/${user.id}/view`) } className="bg-info-focus xpo_text-info-600 xpo_w-40-px xpo_h-40-px rounded-circle xpo_flex xpo_justify-center xpo_items-center" ><Eye className="icon xpo_text-xl" /></Link>
                                                    {/* <button
