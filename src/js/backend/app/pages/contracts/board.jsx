                            ...
                            <div className="w-25 kanban-item radius-12 overflow-hidden">
                                <div className="card xpo_p-0 radius-12 overflow-hidden shadow-none">
                                    <div className="card-body xpo_p-24">
                                        <button
                                            type="button"
                                            className="add-kanban xpo_flex xpo_items-center xpo_gap-2 fw-medium xpo_w-100 xpo_text-primary-600 xpo_justify-content-center xpo_text-hover-primary-800 line-height-1"
                                        ...
                                        >
                                            <CirclePlus className="icon xpo_text-xl xpo_flex" /> 
                                            {__('Add Column')}
                                        </button>
                                    </div>
                                </div>
        ...
        <div className="w-25 xpo_w-80 kanban-item radius-12 pending-card xpo_min-w-60 md:xpo_min-w-80">
            <div className="card xpo_p-0 radius-12 overflow-unset shadow-none">
                <div className="card-body xpo_p-0 xpo_pb-24">
                    <div className="xpo_flex xpo_items-center xpo_gap-2 xpo_justify-content-between ps-24 xpo_pt-24 pe-24">
                        <h6 className="text-lg fw-semibold xpo_mb-0">
                            <input
                                type="text"
                                className="form-control bg-transparent xpo_text-lg fw-semibold xpo_border-none focus:xpo_border-solid focus:xpo_border-primary-600"
                        ...
                        <div className="xpo_flex xpo_items-center xpo_gap-3 xpo_justify-content-between xpo_mb-0">
                                ...
                                <ul className={ `dropdown-menu xpo_p-12 border bg-base shadow ${menuOpened ? 'show' : null}` } ref={dropdownRef}>
                                    <li>
                                        <button
                                            ...
                                            className="duplicate-button dropdown-item px-16 py-8 rounded xpo_text-secondary-light bg-hover-neutral-200 xpo_text-hover-neutral-900 xpo_flex xpo_items-center xpo_gap-2"
                                        >
                                    ...
                                    <li>
                                        <button
                                            onClick={(e) => {
                                                ...
                                                setPopup(
                                                    <div className="xpo_relative xpo_max-w-sm xpo_flex xpo_flex-col xpo_gap-5">
                                                        <h6 className="xpo_text-primary-500 xpo_text-lg fw-semibold">{__('Are you sure you want to delete this Column? This can\'t be undone!')}</h6>
                                                        <div className="xpo_flex xpo_flex-nowrap xpo_gap-5 xpo_items-center xpo_justify-end">
                                            ...
                                            className="delete-button dropdown-item px-16 py-8 rounded xpo_text-secondary-light bg-hover-neutral-200 xpo_text-hover-neutral-900 xpo_flex xpo_items-center xpo_gap-2"
                                        >
...
const SingleCard = ({ data, __, setPopup, empty, setProject, hooks={} }) => {
    ...
    return (
        <div
            ...
            className={ `kanban-card bg-neutral-50 xpo_p-16 radius-8 xpo_mb-24 xpo_cursor-pointer` }
        >
            <h6 className="kanban-title xpo_text-lg fw-semibold xpo_mb-8">{empty(card?.title, __('Untitled card'))}</h6>
            <p className="kanban-desc xpo_text-secondary-light xpo_text-ellipsis xpo_line-clamp-3 xpo_leading-normal">{card?.description}</p>
            {(card?.tags??[]).map((tag, tagIndex) => (
                <button key={tagIndex} type="button" className="btn xpo_text-primary-600 border rounded border-primary-600 bg-hover-primary-600 xpo_text-hover-white xpo_flex xpo_items-center xpo_gap-2">
                    <Tag className="icon" /><span className="kanban-tag fw-semibold">{tag}</span>
                </button>
            ))}
            <div className="mt-12 xpo_flex xpo_items-center xpo_justify-content-between xpo_gap-10">
                <div className="xpo_flex xpo_items-center xpo_justify-content-between xpo_gap-10">
                ...
                <div className="xpo_flex xpo_items-center xpo_justify-content-between xpo_gap-10 xpo_relative">
                    <button
                        type="button"
                    ...
                    <button
                        ...
                        onClick={(e) => {
                            ...
                            setPopup(
                                <div className="xpo_relative xpo_max-w-sm xpo_flex xpo_flex-col xpo_gap-5">
                                    <h6 className="xpo_text-primary-500 xpo_text-lg fw-semibold">{__('Are you sure you want to delete this card? This can\'t be undone!')}</h6>
                                    <div className="xpo_flex xpo_flex-nowrap xpo_gap-5 xpo_items-center xpo_justify-end">
                                        <button className="btn btn-light-100 xpo_text-dark radius-8 px-15 py-6" onClick={() => setPopup(null)}>{__('No, cancel')}</button>
                                        <button className="btn btn-danger-600 radius-8 px-15 py-6" onClick={(e) => {
                                            e.preventDefault();
                                ...
                                <div className="xpo_flex xpo_flex-col xpo_gap-2">
                                    ...
                                    <div className="xpo_flex xpo_flex-col xpo_gap-2 xpo_max-w-[650px]">
                                        <EditorProvider>
                                            ...
                                            <button type="button" className="btn btn-primary xpo_mt-2 xpo_flex xpo_items-center xpo_justify-center xpo_w-fit xpo_gap-3 xpo_px-6 xpo_py-2 disabled:xpo_bg-slate-300 disabled:xpo_border-slate-300" disabled={editingComment.comment.trim() === '<br>' || editingComment.comment.trim() === ''} onClick={(e) => 
                        ...
                        <div className="xpo_flex xpo_flex-col xpo_gap-3 xpo_sticky xpo_top-4 xpo_self-start">
                            ...
                            <div className="xpo_flex xpo_flex-col xpo_gap-2 xpo_px-3 xpo_py-4">
                                {members?.length ? (
                                    <button
                                        type="button"
                                        className="btn btn-light-100 xpo_text-dark radius-8 px-14 py-6 xpo_text-sm xpo_flex xpo_justify-start xpo_items-center xpo_gap-2"
                                    ...
                                    <button
                                        ...
                                        onClick={(e) => {
                                            ...
                                            setShowPops(() => () => {
                                                ...
                                                return (
                                                    <div className="xpo_flex xpo_flex-col xpo_gap-2">
                                                        <h6 className="xpo_text-primary-500 xpo_text-lg fw-semibold">{__('Members')}</h6>
                                                        {people.length ? (
                                                            <div>
                                ...
                                <button
                                    ...
                                    onClick={(e) => {
                                        ...
                                        setShowPops(() => () => {
                                            ...
                                            return (
                                                <div className="xpo_flex xpo_flex-col xpo_gap-3">
                                                    <h6 className="xpo_text-primary-500 xpo_text-lg fw-semibold">
                                                        <input
                                                            type="text"
                                                            value={check?.title}
