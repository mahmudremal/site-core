...
const Referrals = ({ filters = 'any' }) => {
    ...
    return (
        <div className="card xpo_p-0 radius-12 xpo_shadow-none xpo_p-0">
            <div className="card-header border-bottom bg-base py-16 px-24 xpo_flex xpo_items-center xpo_flex-wrap xpo_gap-3 xpo_justify-content-between">
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td className="text-center">
                                            <div className="xpo_flex xpo_items-center xpo_gap-10 xpo_justify-content-center">
                                                <Link to={ home_url(`/referrals/${referral.id}/view`) } className="bg-info-focus xpo_text-info-600 xpo_w-40-px xpo_h-40-px rounded-circle xpo_flex xpo_justify-center xpo_items-center" ><Eye className="icon xpo_text-xl" /></Link>
                                                {/* <button
                ...
                <div className="card xpo_h-100 radius-8 border-0">
                    <div className="card-body xpo_p-24">
                        ...
                        <div className="mt-3">
                            ...
                            <div className="xpo_flex xpo_items-center xpo_justify-content-between xpo_gap-3 xpo_mb-12">
                                <div className="xpo_flex xpo_items-center">
                                    <span className="text-xxl line-height-1 xpo_flex align-content-center xpo_flex-shrink-0 xpo_text-orange">
                                        <Mail className="icon" />
                                    </span>
                            ...
                            <div className="xpo_flex xpo_items-center xpo_justify-content-between xpo_gap-3 xpo_mb-12">
                                <div className="xpo_flex xpo_items-center">
                                    <span className="text-xxl line-height-1 xpo_flex align-content-center xpo_flex-shrink-0 xpo_text-success-main">
                            ...
                            <div className="xpo_flex xpo_items-center xpo_justify-content-between xpo_gap-3 xpo_mb-12">
                                <div className="xpo_flex xpo_items-center">
                                    <span className="text-xxl line-height-1 xpo_flex align-content-center xpo_flex-shrink-0 xpo_text-info-main">
                            ...
                            <div className="xpo_flex xpo_items-center xpo_justify-content-between xpo_gap-3">
                                <div className="xpo_flex xpo_items-center">
                                    <span className="text-xxl line-height-1 xpo_flex align-content-center xpo_flex-shrink-0 xpo_text-indigo">
