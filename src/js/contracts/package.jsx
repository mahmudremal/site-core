    ...
    const ServicePopup = ({ tax_id }) => {
        ...
        return (
            <div className="xpo_w-full xpo_max-w-4xl xpo_mx-auto xpo_rounded-2xl xpo_overflow-hidden">
                ...
                <div className="xpo_bg-gradient-to-r xpo_from-agreements-500 xpo_to-agreements-600 xpo_px-8 xpo_py-6">
                            ...
                            return (
                                <div key={index} className="xpo_flex xpo_items-center xpo_flex-1">
                                    <div className={`xpo_flex xpo_items-center xpo_justify-center xpo_w-10 xpo_h-10 xpo_rounded-full xpo_border-2 xpo_transition-all xpo_duration-300 ${
                                        index <= step 
                                            ? 'xpo_bg-white xpo_border-white xpo_text-agreements-600' 
                                            : 'xpo_border-white/50 xpo_text-white/50'
                                    }`}>
                                        <Icon size={20} />
                                    </div>
                                    <div className="xpo_ml-3 xpo_flex-1">
                                        <p className={`xpo_text-sm xpo_font-semibold xpo_transition-all xpo_duration-300 ${
                ...
                <div className="xpo_p-8">
                    ...
                    {step === 0 && (
                        <div className="xpo_space-y-6">
                                ...
                                {loading ? (
                                    ...
                                    services.map((service, i) => (
                                        <div key={i} className={`xpo_border-2 xpo_rounded-lg xpo_p-6 xpo_transition-all xpo_duration-200 xpo_cursor-pointer hover:xpo_shadow-lg ${
                                            service?.checked 
                                                ? 'xpo_border-agreements-500 xpo_bg-agreements-50' 
                                            ...
                                            <label htmlFor={`service-${service.id}`} className="xpo_cursor-pointer xpo_flex xpo_items-start xpo_gap-4">
                                                <input
                                                    ...
                                                    className="xpo_mt-1 xpo_w-5 xpo_h-5 xpo_text-agreements-600 xpo_border-gray-300 xpo_rounded focus:xpo_ring-agreements-500"
                                                />
                                                    ...
                                                    <div className="xpo_flex xpo_items-center xpo_justify-between">
                                                        ...
                                                        <div className="xpo_flex xpo_items-center xpo_gap-2">
                                                            {service.pricing?.primary && (
                                                                <span className="xpo_bg-agreements-100 xpo_text-agreements-800 xpo_px-3 xpo_py-1 xpo_rounded-full xpo_text-sm xpo_font-medium">
                                                                    ${service.pricing.primary}
                                                                </span>
                                                            )}
                                                            <a 
                                                                ...
                                                                className="xpo_text-agreements-500 hover:xpo_text-agreements-600 xpo_transition-colors"
                            ...
                            {selectedServices.length > 0 && (
                                <div className="xpo_bg-gradient-to-r xpo_from-agreements-50 xpo_to-agreements-50 xpo_border xpo_border-agreements-200 xpo_rounded-lg xpo_p-6">
                                    ...
                                    <div className="xpo_mt-3">
                                        ...
                                        <div className="xpo_flex xpo_flex-wrap xpo_gap-2 xpo_mt-2">
                                            {selectedServices.map((service, i) => (
                                                <span key={i} className="xpo_bg-agreements-100 xpo_text-agreements-800 xpo_px-3 xpo_py-1 xpo_rounded-full xpo_text-sm">
                                                    {service.title}
                                                </span>
                                            ))}
                                        </div>
                                ...
                                <div className="xpo_grid xpo_grid-cols-1 md:xpo_grid-cols-2 xpo_gap-6">
                                    <div className="xpo_space-y-2">
                                        ...
                                        <input
                                            ...
                                            className="xpo_w-full xpo_p-3 xpo_border xpo_border-gray-300 xpo_rounded-lg focus:xpo_ring-2 focus:xpo_ring-agreements-500 focus:xpo_border-transparent xpo_transition-all" 
                    ...
                    {step === 2 && (
                        <div className="xpo_space-y-6">
                            ...
                            <div className="xpo_bg-agreements-50 xpo_border xpo_border-agreements-200 xpo_rounded-lg xpo_p-4">
                                <p className="xpo_text-agreements-800 xpo_text-sm">
                    ...
                    {step === 4 && (
                        <div className="xpo_space-y-6">
                            <div className="xpo_text-center xpo_mb-8">
                                <CheckCircle size={64} className="xpo_mx-auto xpo_text-agreements-500 xpo_mb-4" />
                            ...
                            <div className="xpo_bg-gradient-to-br xpo_from-agreements-50 xpo_to-agreements-50 xpo_border xpo_border-agreements-200 xpo_rounded-lg xpo_p-8">
                                <div className="xpo_flex xpo_items-start xpo_gap-4">
                                    <CreditCard size={32} className="xpo_text-agreements-600 xpo_flex-shrink-0 xpo_mt-1" />
                                    <div>
                        ...
                        <div className="xpo_flex xpo_items-center xpo_gap-3">
                            {step === 2 && config?.phone && (
                                <a 
                                    ...
                                    className="xpo_flex xpo_items-center xpo_gap-2 xpo_px-6 xpo_py-3 xpo_bg-agreements-100 hover:xpo_bg-agreements-200 xpo_text-agreements-700 xpo_rounded-lg xpo_transition-colors xpo_duration-200"
                                >
                                    <Phone size={16} />
                                    Talk First
                                </a>
                            ...
                            {step < 3 && (
                                <div 
                                    ...
                                    className="xpo_flex xpo_items-center xpo_gap-2 xpo_px-6 xpo_py-3 xpo_bg-agreements-600 hover:xpo_bg-agreements-700 disabled:xpo_bg-gray-300 xpo_cursor-pointer disabled:xpo_cursor-not-allowed xpo_text-white xpo_rounded-lg xpo_transition-colors xpo_duration-200"
                                >
                                    Continue
                                    <ArrowRight size={16} />
                                </div>
                            ...
                            {step === 3 && (
                                <div 
                                    ...
                                    className="xpo_flex xpo_items-center xpo_gap-2 xpo_px-6 xpo_py-3 xpo_bg-agreements-600 hover:xpo_bg-agreements-700 disabled:xpo_bg-gray-300 xpo_text-white xpo_rounded-lg xpo_transition-colors xpo_duration-200 xpo_cursor-pointer"
                                >
