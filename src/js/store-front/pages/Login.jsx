...
import { Eye, EyeOff, Mail, Lock, User, Phone, ArrowRight, Shield, Star, Users } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit} className="xpo_space-y-6">
                ...
                {isRegister && (
                  <div className="xpo_flex xpo_items-start xpo_gap-3">
                    ...
                    />
                    <label htmlFor="agreeTerms" className="xpo_text-sm xpo_text-gray-600" dangerouslySetInnerHTML={{__html: sprintf(__('I agree to the %s Terms of Service %s and %s Privacy Policy %s', 'site-core'), '<a href="#" className="xpo_text-scaccent-600 hover:xpo_text-scaccent-800 xpo_underline">', '</a>', '<a href="#" className="xpo_text-scaccent-600 hover:xpo_text-scaccent-800 xpo_underline">', '</a>')}}>
                    </label>
                  </div>
                )}
                ...
                {!isRegister && (
                  <div className="xpo_flex xpo_items-center xpo_justify-between">
                    ...
                    <a href="#" className="xpo_text-sm xpo_text-scaccent-600 hover:xpo_text-scaccent-800 xpo_underline">
                ...
                >
                  {isRegister ? __('Create Account', 'site-core') : __('Sign In', 'site-core')}
