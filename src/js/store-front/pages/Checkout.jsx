              ...
              {cart.cart_items.map((item) => (
                <div key={item.id} className="xpo_flex xpo_gap-3">
                  ...
                  <div className="xpo_flex-1">
                    <h3 className="xpo_font-medium xpo_text-gray-900 xpo_text-sm">{item.product_name || item.product_data?.title}</h3>
                    <p className="xpo_text-gray-600 xpo_text-sm">{money(item.price, item.currency || item.product_data?.metadata?.currency)}</p>
                  </div>
                </div>
              ))}
            </div>
