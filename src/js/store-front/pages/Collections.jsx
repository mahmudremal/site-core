  ...
  return (
    <div>
      ...
      <div className="xpo_bg-scwhite-50 dark:xpo_bg-scprimary-50 xpo_relative xpo_min-h-screen xpo_py-8">
        ...
        <div className="xpo_container xpo_relative xpo_z-10 xpo_mx-auto xpo_px-4 sm:xpo_px-6 lg:xpo_px-8 xpo_py-8">
          <div className="xpo_mb-8">
            <h1 className="xpo_text-4xl xpo_font-bold xpo_mb-4 xpo_text-scwhite dark:xpo_text-scwhite">{__('Collections', 'site-core')}</h1>
