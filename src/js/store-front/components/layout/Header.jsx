...
function SearchAutocomplete({ searchTerm, visible, highlightedIndex, onSelect, autocompleteRef }) {
  ...
  return (
    <div
      ref={autocompleteRef}
      className="xpo_absolute xpo_z-30 xpo_w-full xpo_mt-2 xpo_bg-white xpo_shadow-2xl xpo_rounded-lg xpo_border xpo_border-gray-200 xpo_max-h-96 xpo_overflow-hidden"
      role="listbox"
      ...
      <div className="xpo_max-h-80 xpo_overflow-auto">
        {filteredSuggestions.map((item, idx) => (
          <div
            ...
            className={`xpo_group xpo_cursor-pointer xpo_px-4 xpo_py-3 xpo_border-b xpo_border-gray-100 xpo_flex xpo_items-center xpo_justify-between hover:xpo_bg-blue-50 xpo_transition-all xpo_duration-200 ${
              highlightedIndex === idx ? "xpo_bg-blue-50" : ""
            }`}
          >
            <div className="xpo_flex xpo_items-center xpo_gap-3">
              <Search size={14} className="xpo_text-gray-400" />
              <div dangerouslySetInnerHTML={{__html: sprintf(__('%s %sin %s %s', 'site-core'), `<div class="xpo_text-sm xpo_text-gray-800 group-hover:xpo_text-blue-700">${item.text}</div>`, `<div class="xpo_text-xs xpo_text-gray-500">`, `</div>`)}}></div>
            </div>
            {item.trending && (
              <div className="xpo_flex xpo_items-center xpo_gap-1 xpo_px-2 xpo_py-1 xpo_bg-orange-100 xpo_rounded-full">
                <TrendingUp size={12} className="xpo_text-orange-500" />
                <span className="xpo_text-xs xpo_text-orange-600 xpo_font-medium">
...
function CategoriesDropdown({ selectedCategory, onCategorySelect }) {
  ...
  return (
    <Dropdown button={(
      ...
      <div className="xpo_bg-white xpo_shadow-lg xpo_rounded-lg xpo_border xpo_border-gray-200 xpo_min-w-[200px] xpo_max-h-80 xpo_overflow-auto">
        <div className="xpo_p-3 xpo_border-b xpo_bg-gray-50">
        ...
        {categories.map((category) => (
          <button
            ...
            className={`xpo_w-full xpo_text-left xpo_px-4 xpo_py-2 xpo_text-sm hover:xpo_bg-blue-50 xpo_transition-colors xpo_border-b xpo_border-gray-100 last:xpo_border-b-0 ${
              selectedCategory === category
                ? "xpo_bg-blue-50 xpo_text-blue-700 xpo_font-medium"
                : "xpo_text-gray-700"
            }`}
          >
            {category}
  ...
  return (
    <Dropdown button={(
      <button
        ...
        className="xpo_flex xpo_items-center xpo_gap-2 xpo_text-sm hover:xpo_text-blue-300 xpo_transition-colors"
      >
      ...
      <div className="xpo_bg-white xpo_rounded-lg xpo_min-w-[200px]">
        <div className="xpo_p-3 xpo_border-b xpo_bg-gray-50">
          <h4 className="xpo_text-sm xpo_font-semibold xpo_text-gray-700">{__('Choose Language', 'site-core')}</h4>
        </div>
        {languages.map((language) => (
          <button
            key={language.code}
            onClick={() => onLanguageSelect(language.code)}
            className={`xpo_w-full xpo_text-left xpo_px-4 xpo_py-3 xpo_text-sm hover:xpo_bg-blue-50 xpo_transition-colors xpo_border-b xpo_border-gray-100 last:xpo_border-b-0 xpo_flex xpo_items-center xpo_gap-3 ${
          ...
          >
            ...
            {currentLanguage === language.code && (
              <span className="xpo_ml-auto xpo_text-blue-500">✓</span>
            )}
          </button>
        ))}
      </div>
    ...
    <Dropdown button={(
      ...
      >
        ...
        <div className="xpo_text-left">
          <div className="xpo_text-xs xpo_leading-tight xpo_text-gray-300">
            {isSignedIn ? sprintf(__('Hello, %s', 'site-core'), 'Jhon') : __('Hello, sign in', 'site-core')}
          </div>
          <div className="xpo_font-semibold xpo_text-white">{__('Account & Lists', 'site-core')}</div>
        </div>
        <ChevronDown size={14} />
      </button>
    )}>
      <div className="xpo_bg-white xpo_shadow-lg xpo_rounded-lg xpo_border xpo_border-gray-200 xpo_min-w-[280px]">
        {!isSignedIn ? (
          <div className="xpo_p-4 xpo_border-b xpo_bg-gray-50 xpo_text-center xpo_flex xpo_flex-col xpo_gap-2">
            <Link to="/auth/signin" className="xpo_w-full xpo_bg-yellow-400 hover:xpo_bg-yellow-500 xpo_text-gray-900 xpo_py-2 xpo_px-4 xpo_rounded-lg xpo_font-medium xpo_transition-colors xpo_mb-2">
            ...
            <div className="xpo_text-xs xpo_text-gray-600">
              ...
              <Link to="/auth/register" className="xpo_text-blue-600 hover:xpo_text-blue-700 xpo_ml-1">
        ...
        <div className="xpo_p-2">
          <div className="xpo_mb-3">
            ...
            <Link to="/my-bookmark" className="xpo_w-full xpo_text-left xpo_px-4 xpo_py-2 xpo_text-sm xpo_text-gray-700 hover:xpo_bg-gray-50 xpo_rounded">
          ...
          <div className="xpo_border-t xpo_pt-3">
            <h4 className="xpo_text-sm xpo_font-semibold xpo_text-gray-700 xpo_px-2 xpo_py-2">
              {__('Your Account', 'site-core')}
            </h4>
            <Link to="/clients-portal/my/overview" className="xpo_w-full xpo_text-left xpo_px-4 xpo_py-2 xpo_text-sm xpo_text-gray-700 hover:xpo_bg-gray-50 xpo_rounded">
              <User size={16} className="xpo_inline xpo_mr-3 xpo_text-gray-400" />
              {__('Account', 'site-core')}
            </Link>
            <Link to="/orders/history" className="xpo_w-full xpo_text-left xpo_px-4 xpo_py-2 xpo_text-sm xpo_text-gray-700 hover:xpo_bg-gray-50 xpo_rounded">
              <Package size={16} className="xpo_inline xpo_mr-3 xpo_text-gray-400" />
              {__('Orders', 'site-core')}
            </Link>
            <button className="xpo_w-full xpo_text-left xpo_px-4 xpo_py-2 xpo_text-sm xpo_text-gray-700 hover:xpo_bg-gray-50 xpo_rounded">
              <Star size={16} className="xpo_inline xpo_mr-3 xpo_text-gray-400" />
              {__('Recommendations', 'site-core')}
            </button>
            <Link to="/history/products" className="xpo_w-full xpo_text-left xpo_px-4 xpo_py-2 xpo_text-sm xpo_text-gray-700 hover:xpo_bg-gray-50 xpo_rounded">
              <Clock size={16} className="xpo_inline xpo_mr-3 xpo_text-gray-400" />
              {__('Browsing History', 'site-core')}
            </Link>
            {/* <Link to="/watch/history" className="xpo_w-full xpo_text-left xpo_px-4 xpo_py-2 xpo_text-sm xpo_text-gray-700 hover:xpo_bg-gray-50 xpo_rounded">
              <Heart size={16} className="xpo_inline xpo_mr-3 xpo_text-gray-400" />
...
function DeliveryZonePicker() {
  ...
  return (
    <div className="xpo_p-4 xpo_min-w-sm">
      <div className="xpo_text-gray-700 xpo_mb-4">
      ...
      <div className="xpo_flex xpo_gap-2">
        <button className="xpo_px-4 xpo_py-2 xpo_text-sm xpo_text-gray-600 hover:xpo_text-gray-800 xpo_transition-colors">
        ...
        <button
          onClick={(e) => {
            e.preventDefault();
            setPopup(
              <div className="xpo_bg-white xpo_p-6 xpo_rounded-lg xpo_max-w-md xpo_w-full">
                <h3 className="xpo_text-lg xpo_font-semibold xpo_mb-2">{__('Choose your location', 'site-core')}</h3>
                <p className="xpo_text-sm xpo_text-gray-600 xpo_mb-4">
                  {__('Delivery options and delivery speeds may vary for different locations', 'site-core')}
                </p>
                
                <button className="xpo_w-full xpo_bg-yellow-400 hover:xpo_bg-yellow-500 xpo_text-gray-900 xpo_py-2 xpo_px-4 xpo_rounded-lg xpo_font-medium xpo_transition-colors xpo_mb-4">
                  {__('Sign in to see your addresses', 'site-core')}
                </button>
                
                <div className="xpo_text-center xpo_text-sm xpo_text-gray-500 xpo_mb-4">{__('or enter a US zip code', 'site-core')}</div>
                ...
                <div className="xpo_text-center xpo_text-sm xpo_text-gray-500 xpo_mb-4">{__('or ship outside the US', 'site-core')}</div>
                
                <select className="xpo_w-full xpo_border xpo_border-gray-300 xpo_rounded xpo_px-3 xpo_py-2 xpo_text-sm xpo_mb-4">
                ...
                <button onClick={(e) => {e.preventDefault();setPopup(null);}} className="xpo_w-full xpo_bg-blue-600 hover:xpo_bg-blue-700 xpo_text-white xpo_py-2 xpo_px-4 xpo_rounded-lg xpo_font-medium xpo_transition-colors">{__('Done', 'site-core')}</button>
              </div>
            );
          }}
          className="xpo_bg-blue-600 hover:xpo_bg-blue-700 xpo_text-white xpo_px-4 xpo_py-2 xpo_rounded xpo_text-sm xpo_font-medium xpo_transition-colors"
        >
...
export default function SiteHeader() {
  ...
  return (
    <header className="xpo_bg-gradient-to-t xpo_from-scprimary-700 xpo_via-scprimary-600 xpo_to-scprimary-500 xpo_text-white">
      <div className="xpo_container xpo_mx-auto xpo_flex xpo_items-center xpo_gap-4 xpo_px-4 xpo_py-3">
        ...
        {/* Delivery Location */}
        <Dropdown button={(
          <div className="xpo_flex xpo_items-center xpo_gap-1 xpo_text-sm xpo_cursor-pointer hover:xpo_text-blue-300 xpo_transition-colors">
            <MapPin size={18} />
        ...
        {/* Search Section */}
        <div className="xpo_flex xpo_flex-1 xpo_items-center xpo_bg-white xpo_rounded-lg xpo_overflow-hidden xpo_shadow-md">
          {/* Categories Dropdown */}
          <CategoriesDropdown 
          ...
          {/* Search Button */}
          <button
            className="xpo_h-12 xpo_w-12 xpo_bg-orange-400 hover:xpo_bg-orange-500 xpo_text-white xpo_flex xpo_items-center xpo_justify-center xpo_transition-colors"
            aria-label="Search"
          >
            <Search size={20} />
          </button>
        ...
        {/* Theme Selector */}
        {/* <button onClick={() => toggleTheme()} title="Toggle Light/Dark Mode" className="xpo_cursor-pointer hover:xpo_text-blue-300 xpo_transition-colors">
        ...
        >
          <Undo size={18} />
          <div className="xpo_text-left">
            <div className="xpo_text-xs xpo_leading-tight xpo_text-gray-300">Returns</div>
            <div className="xpo_font-semibold">& Orders</div>
          </div>
        </Link>

        {/* Cart */}
        <Link to="/carry" aria-label="Shopping Cart" className="xpo_relative xpo_flex xpo_items-center xpo_gap-2 hover:xpo_text-blue-300 xpo_transition-colors">
          <div className="xpo_relative">
            <ShoppingCart size={28} />
            {cart?.length ? <span className="xpo_absolute xpo_-top-2 xpo_-right-2 xpo_bg-orange-500 xpo_text-white xpo_text-xs xpo_font-bold xpo_rounded-full xpo_w-6 xpo_h-6 xpo_flex xpo_items-center xpo_justify-center xpo_ring-2 xpo_ring-gray-900">{cart?.length}</span> : null}
          </div>
