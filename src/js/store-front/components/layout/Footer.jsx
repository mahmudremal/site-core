  ...
  return (
    <div className="xpo_relative xpo_z-10">
      <div className="xpo_container xpo_mx-auto xpo_px-6 xpo_grid xpo_grid-cols-1 md:xpo_grid-cols-4 xpo_gap-8">
        {/* Company Info */}
        <div>
          <h3 className="xpo_text-xl xpo_font-semibold xpo_mb-4">{__('MoonlitMeadow', 'site-core')}</h3>
          ...
          <address className="xpo_not-italic xpo_mt-4 xpo_text-xs xpo_text-gray-400" dangerouslySetInnerHTML={{__html: 
        ...
        {/* Customer Service */}
        <div>
          <h4 className="xpo_text-lg xpo_font-semibold xpo_mb-4">{__('Customer Service', 'site-core')}</h4>
          <ul className="xpo_space-y-2 xpo_text-sm">
            <li><Link to="/help" className="hover:xpo_text-white">{__('Help Center', 'site-core')}</Link></li>
            <li><Link to="/returns" className="hover:xpo_text-white">{__('Returns & Refunds', 'site-core')}</Link></li>
            <li><Link to="/shipping" className="hover:xpo_text-white">{__('Shipping Info', 'site-core')}</Link></li>
            <li><Link to="/track" className="hover:xpo_text-white">{__('Track Order', 'site-core')}</Link></li>
            <li><Link to="/contact" className="hover:xpo_text-white">{__('Contact Us', 'site-core')}</Link></li>
          </ul>
        </div>

        {/* Policies */}
        <div>
          <h4 className="xpo_text-lg xpo_font-semibold xpo_mb-4">{__('Policies', 'site-core')}</h4>
          <ul className="xpo_space-y-2 xpo_text-sm">
            <li><Link to="/privacy" className="hover:xpo_text-white">{__('Privacy Policy', 'site-core')}</Link></li>
            <li><Link to="/terms" className="hover:xpo_text-white">{__('Terms of Service', 'site-core')}</Link></li>
            <li><Link to="/security" className="hover:xpo_text-white">{__('Security', 'site-core')}</Link></li>
            <li><Link to="/sitemap" className="hover:xpo_text-white">{__('Sitemap', 'site-core')}</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="xpo_mt-8">
            <h4 className="xpo_text-lg xpo_font-semibold xpo_mb-2">{__('Follow Us', 'site-core')}</h4>
