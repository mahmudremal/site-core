...
const MainLayout = ({ children }) => {
    ...
    return (
        <section>
            ...
            <main className={ `dashboard-main relative ${miniSidebar ? 'active' : null}` }>
                    ...
                    <div className="row xpo_items-center xpo_justify-between">
                        ...
                        <div className="col-auto">
                            <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_gap-3">
                                ...
                                <button type="button" data-theme-toggle className="w-40-px xpo_h-40-px bg-neutral-200 rounded-circle flex xpo_justify-content-center xpo_items-center" onClick={switchTheme}>
                ...
                <div className="dashboard-main-body xpo_h-[calc(100vh-72px*1)] overflow-hidden overflow-y-scroll xpo_p-0">
                    <div className="p-[15px] xpo_pb-0">
                        <Breadcrumb />
                    </div>
                ...
                {opened ? <div className="absolute top-0 left-0 xpo_w-full xpo_h-full bg-slate-600 opacity-50 cursor-auto" onClick={(e) => setOpened(prev => !prev)}></div> : null}
            </main>
        </section>
    );
};
