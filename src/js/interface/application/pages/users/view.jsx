            ...
            <div className="row gy-4">
                <div className="col-lg-4">
                    <div className="user-grid-card position-relative border radius-16 overflow-hidden bg-base xpo_h-100">
                        ...
                        <div className="relative -mt-28 xpo_p-4">
                            <div className="text-center border border-top-0 border-start-0 border-end-0">
                                
                                <div className="relative grid grid-cols-[200px_1fr] items-end xpo_mb-4">
                                    <div className="avatar-upload position-relative">
                                        <div className="avatar-edit position-absolute bottom-0 end-0 me-24 xpo_mt-16 z-1 cursor-pointer">
                                            ...
                                            <label
                                                htmlFor="imageUpload"
                                                className="w-32-px xpo_h-32-px flex xpo_justify-content-center xpo_items-center bg-primary-50 xpo_text-primary-600 border border-primary-600 bg-hover-primary-100 xpo_text-lg rounded-circle"
                                            >
                                                <Camera className="icon" />
                                            </label>
                                        </div>
                                        <div className="avatar-preview !w-52 !h-auto aspect-square">
                                            <div className="w-52 xpo_h-52 rounded-circle overflow-hidden bg-light flex xpo_items-center xpo_justify-content-center">
                                                {(previewImage || user.metadata?.avater) ? (
                                                    <img
                                                        alt={__('Avater')}
                                                        src={previewImage ? previewImage : user.metadata?.avater}
                                                        className=" xpo_w-52 xpo_h-52 object-fit-cover"
                                                    />
                                                ) : (
                                    ...
                                    <div className="relative xpo_text-left xpo_p-3 xpo_mt-12 flex xpo_flex-col xpo_gap-3">
                        ...
                        <div className="card-body xpo_p-24">
                            <ul className="nav border-gradient-tab nav-pills xpo_mb-20 d-inline-flex" id="pills-tab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    <button
                                        className={ `nav-link flex xpo_items-center px-24 ${isActiveTab('edit') && 'active'}` }
                                ...
                                <li className="nav-item" role="presentation">
                                    <button
                                        className={ `nav-link flex xpo_items-center px-24 ${isActiveTab('password') && 'active'}` }
                                ...
                                <li className="nav-item" role="presentation">
                                    <button
                                        className={ `nav-link flex xpo_items-center px-24 ${isActiveTab('notification') && 'active'}` }
                                    ...
                                    {notifConfig ? (
                                        <div>
                                            <div className="form-switch switch-primary py-12 px-16 border radius-8 position-relative xpo_mb-16">
                                                ...
                                                <div className="xpo_flex xpo_items-center xpo_gap-3 xpo_justify-between">
    ...
    return (
        <div className="bg-gray-100">
            <div className="container mx-auto py-8">
                <div className="xpo_grid grid-cols-4 sm:xpo_grid-cols-12 xpo_gap-6 px-4">
                    <div className="col-span-4 sm:xpo_col-span-3">
                        <div className="bg-white shadow rounded-lg xpo_p-6">
                            <div className="xpo_flex xpo_flex-col xpo_items-center">
                                <img
                                    src={user?.avater??'#'}
                                    alt={__('User Avatar')}
                                    className="w-32 xpo_h-32 bg-gray-300 rounded-full xpo_mb-4 shrink-0"
                                />
                                <h5 className="text-xl font-bold">{[user.metadata?.first_name??'', user.metadata?.first_name??''].join(' ').trim()}</h5>
                                <p className="text-gray-700">{user?.metadata?.designation??''}</p>
                                <div className="mt-6 flex xpo_flex-wrap xpo_gap-4 xpo_justify-center">
                                    <a href="#" className="hover:bg-primary-600 bg-primary-500 xpo_text-white py-2 px-4 rounded">{__('Contact')}</a>
                                    <a href="#" className="hover:bg-gray-400 bg-gray-300 xpo_text-gray-700 py-2 px-4 rounded">{__('Resume')}</a>
                                </div>
                            </div>
                            { user.skills?.length > 0 ? <hr className="my-6 border-t border-gray-300" /> : null}
                            { user.skills?.length > 0 ? (
                                <div className="xpo_flex xpo_flex-col">
                                    <span className="text-gray-700 uppercase font-bold tracking-wider xpo_mb-2">{__('Skills')}</span>
                                    <ul>
                    ...
                    <div className="col-span-4 sm:xpo_col-span-9">
                        <div className="bg-white shadow rounded-lg xpo_p-6">
                            <h6 className="text-xl font-bold xpo_mb-4">About Me</h6>
                            <p className="text-gray-700">{user?.metadata?.description??''}</p>
                            {user.socials?.length ? (
                                <>
                                <div className="font-semibold xpo_text-center xpo_mt-3 -mb-2">{__('Find me on')}</div>
                                <div className="xpo_flex xpo_justify-center xpo_items-center xpo_gap-6 my-6">
                                    {user.socials.map((row, idx) => (
                                        ...
                                        >
                                            <Socials platform={row?.platform} className="w-6 xpo_h-auto" />
                                        </a>
                                    ))}
                                </div>
                                </>
                            ...
                            {user.experiences?.length ? <h6 className="text-xl font-bold xpo_mt-6 xpo_mb-4">{__('Experience')}</h6> : null}
                            ...
                            {user.experiences.map((exp, index) => (
                                <div key={index} className="mb-6">
                                    <div className="xpo_flex xpo_justify-between xpo_flex-wrap xpo_gap-2 xpo_w-full">
                                        ...
                                        <p>
                                            <span className="text-gray-700 xpo_mr-2">at {exp.company}</span>
            ...
            {userData ? (
                ...
                <div>
                    <div class="alert alert-danger bg-danger-100 xpo_text-danger-600 border-danger-100 px-24 py-11 xpo_mb-0 fw-semibold xpo_text-lg radius-8" role="alert">
                        <div class="xpo_flex xpo_items-center xpo_justify-between xpo_text-lg">
                            {error} 
                            {/* window.history.back() */}
