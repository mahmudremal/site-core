  ...
  return (
      <div className="card xpo_p-0 radius-12">
          <div className="card-header border-bottom bg-base py-16 px-24 flex xpo_items-center xpo_flex-wrap xpo_gap-3 xpo_justify-between">
              ...
              <button className="btn btn-primary xpo_text-sm btn-sm px-12 py-12 radius-8 flex xpo_items-center xpo_gap-2" onClick={handleUpdate} >
                  { updating == 1 ? <Loader className="icon xpo_text-xl line-height-1 animate-spin" /> : (
                    updating == 2 ? <CheckCheck className="icon xpo_text-xl line-height-1" /> : <Save className="icon xpo_text-xl line-height-1" />
                  ) }
                  {__('Update')}
              </button>
          </div>

          <div className="card-body px-2 py-8">
