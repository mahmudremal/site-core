                ...
                <div className="responsive-padding-40-150 bg-primary-100">
                    <div className="row gy-4 xpo_items-center">
                        <div className="col-xl-7">
                            ...
                            <div className="my-4 flex xpo_flex-wrap xpo_gap-3">
                            ...
                            <div className="text-center">
                                <div className="h-200 flex xpo_justify-content-center xpo_items-center">
                                    <div className="relative">
                                        <p className="text-secondary xpo_text-xl">{__('Loading...')}</p>
                                    </div>
                                </div>
                            </div>
                        ) :
                                                ...
                                                <div className="my-4 flex xpo_flex-wrap xpo_gap-3">
                                                    {ticket.attachements.map((file, index) => (
                                                        <a
                                                            ...
                                                            className="btn btn-outline-primary xpo_mt-4 ms-2 flex xpo_items-center xpo_gap-2"
                                                        >
