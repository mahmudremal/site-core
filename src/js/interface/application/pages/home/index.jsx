...
export default function Home({ setLoading }) {
    ...
    const [insights, setInsights] = useState({total: {}});
    ...
    return (
        <>
            ...
            <div className="xpo_flex xpo_flex-col xpo_gap-5">
                        ...
                        <div className="card shadow-none border bg-gradient-start-1 xpo_h-100">
                            <div className="card-body xpo_p-20">
                                <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-between xpo_gap-3">
                                    <div>
                                        <p className="fw-medium xpo_text-primary-light xpo_mb-1">{__('Total Content SEO')}</p>
                                        <h6 className="mb-0">{insights?.total?.seo?.count??0}</h6>
                                    </div>
                                ...
                                <span className="d-inline-flex xpo_items-center xpo_gap-1 xpo_text-success-main"><ChevronUp className="text-xs" /> {insights?.total?.seo?.lastmonth??0}</span> 
                                Last 30 days Content SEO
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card shadow-none border bg-gradient-start-2 xpo_h-100">
                            <div className="card-body xpo_p-20">
                                <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-between xpo_gap-3">
                                    <div>
                                        <p className="fw-medium xpo_text-primary-light xpo_mb-1">{__('Total Media SEO')}</p>
                                        <h6 className="mb-0">{insights?.total?.media?.count??0}</h6>
                                    </div>
                                ...
                                <p className="fw-medium xpo_text-sm xpo_text-primary-light xpo_mt-12 xpo_mb-0 flex xpo_items-center xpo_gap-2">
                                <span className="d-inline-flex xpo_items-center xpo_gap-1 xpo_text-danger-main"><ChevronDown className="text-xs" /> {insights?.total?.media?.lastmonth??0}</span> 
                                Last 30 days Media SEO
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="col">
                        <div className="card shadow-none border bg-gradient-start-3 xpo_h-100">
                            <div className="card-body xpo_p-20">
                                <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-between xpo_gap-3">
                                    <div>
                                        <p className="fw-medium xpo_text-primary-light xpo_mb-1">{__('Total Free Users')}</p>
                    ...
                    <div className="col">
                        <div className="card shadow-none border bg-gradient-start-5 xpo_h-100">
                            <div className="card-body xpo_p-20">
                                <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-between xpo_gap-3">
                                    <div>
                                        <p className="fw-medium xpo_text-primary-light xpo_mb-1">{__('Total Expense')}</p>
                ...
                <div className="row px-0 row-cols-xxxl-5 row-cols-lg-3 row-cols-sm-2 row-cols-1 gy-4">
                    <div className="row px-0 gy-4 xpo_mt-1 xpo_w-full">
                        <div className="col-xxl-6 col-xl-12">
                            <div className="card xpo_h-100">
                                <div className="card-body">
                                    <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-between">
                                    ...
                                    <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_gap-2 xpo_mt-8">
                                        ...
                                        <span className="text-sm fw-semibold rounded-pill bg-success-focus xpo_text-success-main border br-success px-8 py-4 line-height-1 flex xpo_items-center xpo_gap-1">
                        ...
                        <div className="col-xxl-3 col-xl-6">
                            <div className="card xpo_h-100 radius-8 border-0 overflow-hidden">
                                <div className="card-body xpo_p-24">
                                    ...
                                    <ul className="xpo_flex xpo_flex-wrap xpo_items-center xpo_justify-between xpo_mt-3 xpo_gap-3">
                        ...
                        <div className="col-xxl-9 col-xl-12">
                            <div className="card xpo_h-100">
                                <div className="card-body xpo_p-24">
                                    ...
                                    <div className="xpo_flex xpo_flex-wrap xpo_items-center xpo_gap-1 xpo_justify-between xpo_mb-16">
                                        <ul className="nav border-gradient-tab nav-pills xpo_mb-0" id="pills-tab" role="tablist">
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link flex xpo_items-center active" id="pills-to-do-list-tab" data-bs-toggle="pill" data-bs-target="#pills-to-do-list" type="button" role="tab" aria-controls="pills-to-do-list" aria-selected="true">
                                                    Latest Registered 
                                            ...
                                            <li className="nav-item" role="presentation">
                                                <button className="nav-link flex xpo_items-center" id="pills-recent-leads-tab" data-bs-toggle="pill" data-bs-target="#pills-recent-leads" type="button" role="tab" aria-controls="pills-recent-leads" aria-selected="false" tabIndex="-1">
                                                    Latest Subscribe 
                                                    <span className="text-sm fw-semibold py-6 px-12 bg-neutral-500 rounded-pill xpo_text-white line-height-1 ms-12 notification-alert">35</span>
                                                </button>
                                            </li>
                                        </ul>
                                        <Link to="#" className="text-primary-600 hover-text-primary flex xpo_items-center xpo_gap-1">
                                            View All
                            ...
                            <div className="card xpo_h-100">
                                <div className="card-body">
                                    ...
                                    <div className="mt-32">
                                        ...
                                        <div className="xpo_flex xpo_items-center xpo_justify-between xpo_gap-3 xpo_mb-24">
                                            <div className="xpo_flex xpo_items-center">
                                                <img src="https://randomuser.me/api/portraits/men/1.jpg" alt="" className="w-40-px xpo_h-40-px rounded-circle xpo_flex-shrink-0 me-12 overflow-hidden" />
                                                <div className="xpo_flex-grow-1">
                                                    <h6 className="text-md xpo_mb-0 fw-medium">Dianne Russell</h6>
                        ...
                        <div className="col-xxl-6 col-xl-12">
                            <div className="card xpo_h-100">
                                <div className="card-body">
                                    <div className="xpo_flex xpo_items-center xpo_flex-wrap xpo_gap-2 xpo_justify-between xpo_mb-20">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="h-100 border xpo_p-16 pe-0 radius-8">
                                                <div className="max-h-266-px overflow-y-auto scroll-sm pe-16">
                                                    <div className="xpo_flex xpo_items-center xpo_justify-between xpo_gap-3 xpo_mb-12 xpo_pb-2">
