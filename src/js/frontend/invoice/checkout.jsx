                  ...
                  <div className="xpo_grid xpo_grid-cols-1 md:xpo_grid-cols-2 xpo_gap-4">
                    ...
                    {showEmirate && (
                      <div className="xpo_w-full">
                        <select className="xpo_bg-gray-50 xpo_border xpo_border-gray-300 xpo_text-gray-900 xpo_text-sm xpo_rounded-lg focus:xpo_ring-blue-500 focus:xpo_border-blue-500 xpo_block xpo_w-full xpo_p-2.5 xpo_dark:bg-gray-700 xpo_dark:border-gray-600 xpo_dark:placeholder-gray-400 xpo_dark:text-white xpo_dark:focus:ring-blue-500 xpo_dark:focus:border-blue-500" value={form.metadata?.emirate??''} onChange={(e) => setForm(prev => ({...prev, metadata: {...prev.metadata, emirate: e.target.value}}))}>
                          ...
                          <div className="xpo_flex xpo_flex-nowrap xpo_gap-5 xpo_items-center">
                            ...
                            <div className="xpo_inline-flex xpo_items-center">
                              <label className={ `xpo_flex xpo_items-center xpo_cursor-pointer xpo_relative xpo_rounded-[100%] xpo_border xpo_border-solid ${isActiveProvider(g.id) ? 'xpo_border-none' : null} xpo_overflow-hidden` }>
                                <input type="checkbox" checked={isActiveProvider(g.id)} onChange={() => {}} className="xpo_peer xpo_h-5 xpo_w-5 xpo_cursor-pointer xpo_transition-all xpo_appearance-none xpo_rounded xpo_shadow hover:xpo_shadow-md checked:xpo_bg-primary" id="check3" />
