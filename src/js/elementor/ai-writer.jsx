...
jQuery(window).on('elementor:init', function () {
    ...
    const initAiPanel = () => {
        ...
        if (!el) {
            ...
            el.id = PANEL_ID;
            el.className = 'sitecore-ai-panel-content sc-h-full sc-flex sc-flex-col sc-bg-[#f1f3f5]';
