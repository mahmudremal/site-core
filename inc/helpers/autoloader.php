...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( WP_SITECORE_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\SITE_CORE\inc\Helpers\autoloader' );
